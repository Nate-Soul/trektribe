        ...
        <main>
            ...
            <section className="py-16">
                <div className="container">
                        ...
                        {teamMembers.length > 0 && teamMembers.map((teamMember, teamMemberIndex) => (
                            <figure 
                                ...
                                className={`rounded-lg overflow-hidden mx-auto ${
                                    teamMemberIndex === 2 
                                    ? 'col-start-3 row-start-1 row-span-2 col-span-2 w-[228px] h-[182px]' 
                                    : teamMemberIndex === teamMembers.length - 1 
                                    ? 'col-start-6 row-start-3 row-span-2 col-span-1 w-[121px] h-[127px]' 
                                    : (teamMemberIndex === 0 || teamMemberIndex === 4) 
                                    ? 'row-start-3 row-span-2 col-span-1 w-[121px] h-[127px]' 
                                    : (teamMemberIndex === 1 || teamMemberIndex === 3) 
                                    ? 'row-start-2 row-span-2 col-span-1 w-[121px] h-[127px]' 
                                    : ''
                                }`}
                            >
                                <Image
                    ...
                    <div className="text-[1.375rem] leading-[1.875rem] text-center w-1/2 mx-auto -mt-[15%]">
                        <p>
